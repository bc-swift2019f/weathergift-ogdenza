...
//  WeatherGift
//
//  Created by Zach Ogden on 9/24/19.
...
class DetailVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        locationDetail = WeatherDetail(name: locationsArray[currentPage].name, coordinate: locationsArray[currentPage].coordinates)
...
extension DetailVC: CLLocationManagerDelegate {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        ...
        geoCoder.reverseGeocodeLocation(currentLocation, completionHandler: {placemarks, error in
            ...
            self.locationDetail = WeatherDetail(name: place, coordinate: currentCoordinates)
            self.locationDetail.getWeather {
                self.updateUserInterface()
            }
        })
